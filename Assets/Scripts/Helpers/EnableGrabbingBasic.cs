 ...
 * 3) Use bool hasGrabbed if need be.
*/
	...
	public class EnableGrabbingBasic : MonoBehaviour {
		...
		void Start() {
			...
			if (objectController.GetComponent<Collider>() == null) {
				var colliderController = objectController.AddComponent<SphereCollider> ();
				colliderController.radius = radiusController;
				colliderController.isTrigger = true;
